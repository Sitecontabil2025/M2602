...
function acceptCookieConsent(){
    var fieldCookieNecessary = document.getElementById('sclgpd-checkbox-necessary');
    var fieldCookieFunctionality = document.getElementById('sclgpd-checkbox-functionality');
    var fieldCookieTracking = document.getElementById('sclgpd-checkbox-tracking');
    var fieldCookieTargeting = document.getElementById('sclgpd-checkbox-targeting');

    deleteCookie('user_cookie_consent_necessary');
    deleteCookie('user_cookie_consent_functionality');
    deleteCookie('user_cookie_consent_tracking');
    deleteCookie('user_cookie_consent_targeting');

    if (fieldCookieNecessary.checked) { setCookie('user_cookie_consent_necessary', 'yes', 30); }
    if (fieldCookieFunctionality.checked) { setCookie('user_cookie_consent_functionality', 'yes', 30); }
    if (fieldCookieTracking.checked) { setCookie('user_cookie_consent_tracking', 'yes', 30); }
    if (fieldCookieTargeting.checked) { setCookie('user_cookie_consent_targeting', 'yes', 30); }
    
    document.getElementById("sclgpdNotice").style.display = "none";
    document.getElementById("sclgpdModal").classList.remove('sclgpd-active');
}
...
function acceptAllCookieConsent(){
    ...
    fieldCookieNecessary.checked = true;
    fieldCookieFunctionality.checked = true;
    fieldCookieTracking.checked = true;
    fieldCookieTargeting.checked = true;
    ...
    setCookie('user_cookie_consent_necessary', 'yes', 30);
    setCookie('user_cookie_consent_functionality', 'yes', 30);
    setCookie('user_cookie_consent_tracking', 'yes', 30);
    setCookie('user_cookie_consent_targeting', 'yes', 30);
    
    document.getElementById("sclgpdNotice").style.display = "none";
    document.getElementById("sclgpdModal").classList.remove('sclgpd-active');
}

function removeAllCookieConsent(){
    var fieldCookieNecessary = document.getElementById('sclgpd-checkbox-necessary');
    var fieldCookieFunctionality = document.getElementById('sclgpd-checkbox-functionality');
    var fieldCookieTracking = document.getElementById('sclgpd-checkbox-tracking');
    var fieldCookieTargeting = document.getElementById('sclgpd-checkbox-targeting');
    ...
    fieldCookieNecessary.checked = true;
    fieldCookieFunctionality.checked = false;
    fieldCookieTracking.checked = false;
    fieldCookieTargeting.checked = false;
    
    document.getElementById("sclgpdNotice").style.display = "block";
}

function openCookieConsent(){
    var target = document.getElementById('sclgpdNotice');
    target.classList.toggle('sclgpd-visible');
}